...
import { CircleX, Video, ArrowBigLeft, ArrowBigRight, Star } from 'lucide-react';
                ...
                <div key={index} className="flex flex-col w-3/4 p-2 bg-neutral-800 text-white text-xs rounded-xl">
                    ...
                    <div className="grid grid-cols-[2fr_2fr_2fr] justify-between">
                        <div className="flex flex-col p-1 bg-red-500 rounded-xl">
                            <p className="text-center font-bold text-sm my-1 p-1 bg-red-950 rounded-lg" 
                            onClick={(() => handleScoutMatch(match.teams[0].teamNumber.toString(), match.matchNumber.toString(), match.tournamentLevel, "Red1"))}>{match.teams[0].teamNumber}</p>
                            <p className="text-center font-bold text-sm my-1 p-1 bg-red-950 rounded-lg" 
                            onClick={(() => handleScoutMatch(match.teams[1].teamNumber.toString(), match.matchNumber.toString(), match.tournamentLevel, "Red2"))}>{match.teams[1].teamNumber}</p>
                            <p className="text-center font-bold text-sm my-1 p-1 bg-red-950 rounded-lg" 
                            onClick={(() => handleScoutMatch(match.teams[2].teamNumber.toString(), match.matchNumber.toString(), match.tournamentLevel, "Red3"))}>{match.teams[2].teamNumber}</p>
                        </div>
                        <div className="flex flex-col">
                            
                        </div>
                        <div className="flex flex-col p-1 bg-blue-500 rounded-xl">
                            <p className="text-center font-bold text-sm my-1 p-1 bg-blue-950 rounded-lg" 
                            onClick={(() => handleScoutMatch(match.teams[3].teamNumber.toString(), match.matchNumber.toString(), match.tournamentLevel, "Blue1"))}>{match.teams[0].teamNumber}</p>
                            <p className="text-center font-bold text-sm my-1 p-1 bg-blue-950 rounded-lg" 
                            onClick={(() => handleScoutMatch(match.teams[4].teamNumber.toString(), match.matchNumber.toString(), match.tournamentLevel, "Blue2"))}>{match.teams[1].teamNumber}</p>
                            <p className="text-center font-bold text-sm my-1 p-1 bg-blue-950 rounded-lg" 
                            onClick={(() => handleScoutMatch(match.teams[5].teamNumber.toString(), match.matchNumber.toString(), match.tournamentLevel, "Blue3"))}>{match.teams[2].teamNumber}</p>
                        </div>
                    </div>
                </div>
            ))}
