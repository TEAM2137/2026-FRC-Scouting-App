    ...
    return (
        <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2">
                ...
                <input type="text" className="border border-gray-300 rounded p-2" placeholder="Enter driver skill rating (e.g. 1-10)" />
            </div>      
            <div className="flex flex-col gap-2">
                ...
                <input type="text" className="border border-gray-300 rounded p-2" placeholder="Enter robot reliability rating (e.g. 1-10)" />
            </div>
            <div className="flex flex-col gap-2">
                ...
                <textarea className="border border-gray-300 rounded p-2" placeholder="Enter any additional notes about the team"></textarea>
            </div>
        </div>
    )
}
